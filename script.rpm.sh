...
finalize_yum_repo ()
{
  ...
  echo "Generating yum cache for varnishcache_varnish5-source..."
  yum -q makecache -y --disablerepo='*' --enablerepo='varnishcache_varnish5-source'
}

finalize_zypper_repo ()
{
  zypper --gpg-auto-import-keys refresh varnishcache_varnish5
  zypper --gpg-auto-import-keys refresh varnishcache_varnish5-source
}
...
main ()
{
  ...
  yum_repo_config_url="https://packagecloud.io/install/repositories/varnishcache/varnish5/config_file.repo?os=${os}&dist=${dist}&source=script"
